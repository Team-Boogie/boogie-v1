...
class FlvReader(io.BytesIO):
    ...
    def read_abst(self): # -> dict[str, Unknown]:
        ...
    
    def read_bootstrap_info(self): # -> dict[str, Unknown]:
        ...
    


def read_bootstrap_info(bootstrap_bytes): # -> dict[str, Unknown]:
    ...
...
def remove_encrypted_media(media): # -> list[_T@list]:
    ...
