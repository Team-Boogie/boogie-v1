...
def is_non_updateable(): # -> Literal['You installed yt-dlp with pip or using the wheel f…']:
    ...
...
class Updater:
    ...
    @property
    def current_commit(self): # -> Literal['65cf46cddd873fd229dbb0fc0689bca4c201c6b6']:
        """Current commit hash"""
        ...
