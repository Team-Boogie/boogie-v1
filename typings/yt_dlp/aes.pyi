...
def pad_block(block, padding_mode): # -> list[Unknown]:
    """
...
def iter_vector(iv): # -> Generator[Unknown, Any, None]:
    ...
...
def iter_mix_columns(data, matrix): # -> Generator[Unknown | int, Any, None]:
    ...
