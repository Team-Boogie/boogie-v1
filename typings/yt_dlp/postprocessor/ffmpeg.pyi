...
class FFmpegPostProcessor(PostProcessor):
    ...
    @staticmethod
    def get_versions_and_features(downloader=...): # -> tuple[dict[() -> ..., Unknown | str | Any | dict[str, bool] | bool | None], Unknown | str | Any | dict[str, bool] | bool | None]:
        ...
    
    @staticmethod
    def get_versions(downloader=...): # -> dict[() -> ..., Unknown | str | Any | dict[str, bool] | bool | None]:
        ...
    ...
    @staticmethod
    def stream_copy_opts(copy=..., *, ext=...): # -> Generator[Literal['-map', '0', '-dn', '-ignore_unknown', '-c', 'copy', '-c:s', 'mov_text'], Unknown, None]:
        ...
...
class FFmpegConcatPP(FFmpegPostProcessor):
    ...
    def run(self, info): # -> tuple[list[Unknown], Unknown] | tuple[list[Unknown] | Unknown | type[NO_DEFAULT] | dict[Unknown, Unknown] | None, Unknown]:
        ...
