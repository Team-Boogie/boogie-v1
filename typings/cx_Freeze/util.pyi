...
def BeginUpdateResource(path: str | Path, delete_existing_resources: bool = ...) -> HANDLE:
    """Wrapper for BeginUpdateResource."""
    ...

def UpdateResource(handle: HANDLE, resource_type: int, resource_id: int, resource_data: bytes) -> None:
